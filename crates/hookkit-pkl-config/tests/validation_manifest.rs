...
fn validation_manifest_matches_catalog_and_fixtures() {
    ...
    assert_eq!(summary.fixture_cases, 247);
    assert_eq!(summary.layers[&EvidenceTier::Schema].covered, 134);
    assert_eq!(summary.layers[&EvidenceTier::RenderedCommand].covered, 18);
    assert_eq!(summary.layers[&EvidenceTier::RenderedCommand].gap, 104);
    assert_eq!(summary.layers[&EvidenceTier::PinnedRealTool].covered, 18);
    assert_eq!(summary.layers[&EvidenceTier::PinnedRealTool].gap, 104);
    assert_eq!(
