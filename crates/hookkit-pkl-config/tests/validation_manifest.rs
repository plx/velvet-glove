...
fn validation_manifest_matches_catalog_and_fixtures() {
    ...
    assert_eq!(summary.fixture_tools, 111);
    assert_eq!(summary.fixture_cases, 194);
    assert_eq!(summary.layers[&EvidenceTier::Schema].covered, 134);
    assert_eq!(summary.layers[&EvidenceTier::RenderedCommand].covered, 4);
    assert_eq!(summary.layers[&EvidenceTier::RenderedCommand].gap, 118);
    assert_eq!(summary.layers[&EvidenceTier::PinnedRealTool].covered, 4);
    assert_eq!(summary.layers[&EvidenceTier::PinnedRealTool].gap, 118);
    assert_eq!(
